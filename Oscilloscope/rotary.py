...
class Rotary(object):
    ...
    def set(self, value=None, min_val=None, incr=None,
        ...
        self._hal_disable_irq() #type:ignore
        ...
        self._hal_enable_irq() #type:ignore
    ...
    def _process_rotary_pins(self, pin):
        ...
        clk_dt_pins = (self._hal_get_clk_value() << #type:ignore
                       1) | self._hal_get_dt_value() #type:ignore
